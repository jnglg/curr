...
(command-line
 ...
 [("--language") -language "Select what language you are printing the curriculum for. Default: english"
                   (if (member -language (list "english" "spanish" "fr"))
                       (putenv "LANGUAGE" -language)
                       (raise-user-error (string-append "Build-workbook got unrecognized target language: " -language " -- expected english or spanish or fr")))]
